...
qr_path = r"C:\Users\dhabh\Event_pass_project\images\Qr.jpg"  # Adjust this if your structure is different
if os.path.exists(qr_path):
    st.image(qr_path, caption="Scan to Pay")
else:
...
if screenshot is not None:
    ...
    if st.button("Submit Payment"):
        ...
        # Display user's booking info (from session_state)
